...
public static class GizmoEx {
	...
	public static void DrawRect ( Vector3 position, Vector3 direction, Rect rect ) {
		DrawRect( position, Quaternion.LookRotation( direction ), rect );
	}
	
	public static void DrawRect ( Vector3 position, Quaternion direction, Rect rect ) {
	...
	public static void DrawCircle ( Vector3 position, Vector3 direction, float size ) {
		DrawCircle( position, Quaternion.LookRotation( direction ), size );
	}
	
	public static void DrawCircle ( Vector3 position, Quaternion direction, float size ) {
	...
	public static void DrawNormal ( Vector3 position, Vector3 direction, float size ) {
		DrawNormal( position, Quaternion.LookRotation( direction ), size );
	}
	
	public static void DrawNormal ( Vector3 position, Quaternion direction, float size ) {
		Matrix4x4 matrix = Matrix4x4.TRS( position, direction, Vector3.one * size );
	...
	public static void DrawCameraLineHorizontal ( float pos ) {
	...
	public static void DrawCameraLineVertical ( float pos ) {
	...
	public static void DrawCameraSafeArea ( Vector2 safeSize ) {
